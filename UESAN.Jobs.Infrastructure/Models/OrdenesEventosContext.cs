...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		...
		{
			entity.HasKey(e => e.IdEdicion).HasName("PK__Edicion__8A0A9839F1D9FACC");
		...
		{
			entity.HasKey(e => e.IdEvento).HasName("PK__Eventos__C8DC7BDAFF12602A");
		...
		{
			entity.HasKey(e => e.IdFoto).HasName("PK__foto__69D650940C3255F2");
		...
		{
			entity.HasKey(e => e.IdServicioFotos).HasName("PK__Servicio__A49B09EBE6FA5FA7");
		...
		{
			entity.HasKey(e => e.IdServicios).HasName("PK__Servicio__185EC2A0D329A79F");
		...
		{
			entity.HasKey(e => e.IdStream).HasName("PK__Stream__E1BBB4DFDD6D035D");
		...
		{
			entity.HasKey(e => e.IdUsuario).HasName("PK__Usuarios__645723A666D65312");
		...
		{
			entity.HasKey(e => e.IdVideo).HasName("PK__videos__D2D0AD2A734FADE7");
